...
ball_x_coordinate_server = 0
ball_y_coordinate_server = 0
...
async def run_offer(pc, signaling):
    ...
    async def send_pings():
        ...
        while True:
            ...
            global ball_x_coordinate_server
            global ball_y_coordinate_server
    ...
    def on_message(rec_message):
        ...
        print("Computer Error Between Ball Coordintes - Using Euclidean Distance")
